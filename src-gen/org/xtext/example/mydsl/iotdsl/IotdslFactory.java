...
public interface IotdslFactory extends EFactory
{
   ...
   * @generated
   */
  IotdslFactory eINSTANCE = org.xtext.example.mydsl.iotdsl.impl.IotdslFactoryImpl.init();

  /**
   * Returns a new object of class '<em>Iot</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Iot</em>'.
   * @generated
   */
  Iot createIot();
